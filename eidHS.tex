...
\addchap*{Erklärung} %* nicht entfernen, sonst erhält Erkilärung eine Nummer und erscheint im Inhaltsverzeichnis
...
\begin{center}
{\LARGE{Kommunikation über einen steganografischen Covert Channel}}
\end{center}
