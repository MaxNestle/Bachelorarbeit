...
\include{DeckHS}                % Deckblatt Nummerierung unterdrückt (In Deckblatt festgelegt)
%%\cleardoubleemptypage         % Die Eidesstattliche Erklaerung auf einer rechten Seite beginnen
\include{eidHS}                 % Eidesstattliche Erklaerung Nummerierung unterdrückt
...
\include{kurzfass}             % Kurzfassung der Arbeit
\include{abstract}             % Abstract der Arbeit (englische Kurzfassung der Arbeit)
\include{dasa}								  % Danksagung (optional)
\include{vowo}							    % Vorwort (optional)
...
\include{grundl}                % Ein Kapitel des Hauptteils
\include{hauptteil}						  % Ein weiteres Kapitel des Hauptteils
\include{hauptteil}					  	% Die unterschiedlichen Kapitel
\include{hauptteil}					    % des Hauptteils
\include{hauptteil}					    % sollten hier in der
\include{hauptteil}				  	  % Masterdatei einen sinnvollen
\include{hauptteil}				  	  % Kommentar erhalten
\include{hauptteil}				  	  % z.B. den Titel des Kapitels
\include{hauptteil}				  	  % um für Korrekturen oder Umstellungen
\include{hauptteil}			  		  % leichter gefunden zu werden
\include{schluss}               % Schluss

%%% Anhang %%%          Nummerierung beginnend bei A
\appendix                       % Anhang
 \include{anhang}               % Erstes Kapitel des Anhangs
