...
\begin{center}
{Konstruktion und Implementierung eines versteckten Datenkanals mit Hilfe der Steganographie oder Covert Channels} % Titel der Arbeit
\end{center}
}
...
Abgabedatum :& 29. April 2019   % Das Abgabedatum wird gleichgesetzt mit dem Datum der letzten Compilierung. Statt \today kann auch Datum von Hand geschrieben werden
\end{tabular}
}
\end{center}
