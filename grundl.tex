...
Im den folgenden Kapiteln soll kurz das OSI-Schichtenmodell, auf welches das heutige Internet aufbaut, erklärt werden. \\
Es werden nur die Schichten betrachtet, die für dieses Projekt relevant sind. 
...
Den Transport der Daten in dieser Schicht über nimmt das Ethernet-Protokoll. Dazu werden die Daten in Ethernet Pakete zerteilt. Diese können dann zwischen den Geräten im Netzwerk verschickt werden. Dabei ist das Ethernet-Protokoll immer nur im jeweiligen Netzwerksegment gültig. Die Adressierung wird mit Hilfe der MAC-Adressen realisiert. Diese Adresse ist einmalig und wird jedem netzwerkfähigem Gerät vom Hersteller zugeordnet.
