...
Diese Schicht beinhaltet Protokolle, welche einen weitestgehend fehlerfreie Datenübertragung garantieren sollen. Außerdem wird der Zugriff auf das Übertragungsmedium garantiert.

\subsubsection{Ethernet}

Beim Ethernet-Protokoll werden die Daten in Pakete zerteilt. Diese können dann zwischen den Geräten im Netzwerk verschickt werden. Dabei ist das Ethernet-Protokoll immer nur im jeweiligen Netzwerksegment gültig. Die Adressierung wird mit Hilfe der MAC-Adressen realisiert. Diese Adresse ist einmalig und wird jedem netzwerkfähigem Gerät vom Hersteller zugeordnet.

\includegraphics*[height=2.7cm]{bilder/Ethernet.png}

Erweiterter Ethernet-Frame nach IEEE 802.1Q

\cite{zisler2013computer}


\subsection{ Vermittlungsschicht/Network Layer (Schicht 3)}

Die Protokolle dieser Schicht werden verwendet, um über Netzwerkgrenzen hinaus Nachrichten zu versenden. Dieses Protokoll liegt innerhalb der Nutzdaten des Ethernet-Pakets.
