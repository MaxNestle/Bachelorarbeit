...
\section{Server}
	...
	\section{Back-End}
		\subsection{Express Implementierung}
			...
			\subsection{Kommunikation des Covert Channel}
				...
				\subsubsection{Anforderung an die Kommunikation des Covert Channel}
				...
				\subsubsection{Berwertung der Kommunikation des Covert Channel}
		...
		Um den Covert Channel zu implementieren werden Nachrichten zeitlich verzögert an den Client gesendet. Die Länge der Pause zwischen den Daten hängt davon ab ob eine 1 oder 0 übertragen werden soll. Bei einer 1 wird eine lange Pause zwischen den Paketen gemacht bei einer 0 eine kurze.\\
	...
	\section{Front-End}
		...
		warum nicht hier die auswertung des covert Channel
