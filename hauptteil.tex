...
\subsection{Hash-Funktionen}
	...
	Der Pearson-Algorithmus verwendet eine zufällig initialisierte statische Mapping-Tabelle, um jedes Byte von jedem Hash-Wert auf ein neues Byte für einen neuen Hash-Wert abzubilden.\cite{davies2010traffic}\\
...
\section{Server}
	...
	\section{Back-End Implementierung}
		\subsection{Express}
			...
			\subsection{Kommunikation des Covert Channel}
				...
				Socket.IO ist eine JavaScript-Bibliothek, mit der sich eine bidirektionale Echtzeitkommunikation realisieren lässt. Die Funktion ähnelt einem WebSocket, lässt jedoch eine ereignisgesteuerte Kommunikation zwischen Browser und Server zu.\cite{SOCKET_IO}\\
				Mit Hilfe von Socket.IO wird in dieser Arbeit die Kommunikation zwischen Server und Client hergestellt. Dies macht es möglich Nachrichten jeder Zeit vom Server an den Client zu senden.
		...
		\subsection{Pearson Hash}
	
	\section{Front-End Implementierung}
