...
\section{Wahrung der Authenzität}
...
\chapter{Evaluation}
	Der Server und der Client sind in der Lage einen Covert Channel zu erstellen. Dieser ist in der Lage Daten zu übertragen. Die Kommunikation geschieht verdeckt, kommt aber ohne Verschlüsselung aus.\\
	Das in der Motivation genannte Beispiel würde sich mit dieser Lösung umsetzten lassen. Es können Daten jeglicher Größe übertragen werden. Jedoch macht eine Größe über 200 Byte keinen Sinn, da hier die Chance auf falsch Interpretierte Bits sehr groß wird. Jedoch bietet dieses Projekt eine gute Basis um entsprechende Erweiterungen zu implementieren die das Senden von großen Dateien realistisch machen.\\
...
\chapter{Evaluierung}
		...
		Wie auch bei der aktiven Variante ist eine Datengröße über 200 Byte nicht sinnvoll. Es ist aber eine gute Basis entstanden die gut erweitert werden kann. Durch die Einschränkungen ist es nicht einfach eine geeignete Webseite für den Covert Channel zu finden. Bei einer realen Umsetzung sollte die Verwendung des ersten Lösungsansatzes in Betracht gezogen werden, da man hier auf einer funktionierenden Proxylösung aufbaut und alle Webseiten unterstützt werden.\\
...
\chapter{Mögliche Optimierung}

\subsubsection{Dateien aufeilen}
